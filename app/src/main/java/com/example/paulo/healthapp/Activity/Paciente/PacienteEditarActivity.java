...
public class PacienteEditarActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onBackPressed() {
        int resposta;
        resposta = R.string.paciente_resposta_descartado;
    ...
    private void editaPaciente(){
        ...
        ServicePaciente.update(modelPaciente);
        resposta = R.string.paciente_resposta_dados_alterados;
    ...
    private void inicializaCampos(){
        ...
        modelPaciente = ServicePaciente.getById(1);//sempre retorna um objeto, tendo sido inserido ou nao

        //atualiza os campos com os dados cadastrados
        et_nome.setText(modelPaciente.getNomePaciente());
        et_registro.setText(modelPaciente.getnDeRegistroDaUnidadeSaude());
        et_cartao.setText(modelPaciente.getCartaoNacionalDeSaude());
        tv_data_nascimento.setText(simpleFormat.format(modelPaciente.getDataDeNascimento()));
        et_telefone.setText(modelPaciente.getTelefone());
        et_endereco.setText(modelPaciente.getEndereco());
    ...
    private void carregaTuberculose(){
        ...
        String tipo_tuberculose;
        if(modelPaciente.getTuberculose()!=null)
            tipo_tuberculose = modelPaciente.getTuberculose();
        else
            tipo_tuberculose = getApplicationContext().getResources().getString(R.string.paciente_tuberculose_pulmonar);

        String pulmonar = getApplicationContext().getResources().getString(R.string.paciente_tuberculose_pulmonar);
        if(tipo_tuberculose == pulmonar)
            rpgTipoTuberculose.check(R.id.paciente_rdbtn_pulmonar);
        else
            rpgTipoTuberculose.check(R.id.paciente_rdbtn_extrapulmonar);
    }
    ...
    private void setPesoDialog(){
        ...
        tv_peso.setText(String.format("%d", peso));
